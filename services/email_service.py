                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.07);">
                            ...
                            <tr>
                                <td style="padding: 40px;">
                                    ...
                                    <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                        Thank you for your interest in <strong>{company_name}</strong>. We have prepared a personalized
                                        business audit report that includes industry insights, market trends, and tailored recommendations
                                        specific to your company's profile.
                                    </p>
                                    <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                        The attached PDF contains comprehensive analysis and actionable recommendations to help you
                                        identify growth opportunities and optimize your business operations.
                                    </p>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="background-color: #3B82F6; border-radius: 6px; padding: 0;">
                                                            <span style="display: block; padding: 14px 28px; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600;">
                                                                View Your Report
                                                            </span>
                                                        </td>
                                                    </tr>
                            ...
                            <tr>
                                <td style="background-color: #f1f5f9; padding: 20px 40px; text-align: center;">
                                    <p style="color: #94a3b8; font-size: 12px; margin: 0;">
                                        &copy; {2026} LeadFlow Pro. All rights reserved.<br/>
                                        This email was sent as part of our automated lead enrichment service.
                                    </p>
                                </td>
                            </tr>
                        </table>
...
Thank you for your interest in {company_name}. We have prepared a personalized business audit report that includes industry insights, market trends, and tailored recommendations specific to your company's profile.

The attached PDF contains comprehensive analysis and actionable recommendations to help you identify growth opportunities and optimize your business operations.
